...
// 素材情報 (Materials): the structuring layer and the list of materials.
new #[Title('素材情報')] class extends PagedList {
    // The developer prompt of the structuring (UI: 構造化).
    public string $structuring = '';

    /** UI: 構造化のモデル */
    public string $structuringModel = EditorialPolicy::DEFAULT_MODEL;

    // Load the structuring layer.
    ...
    // Save the structuring prompt and model.
    ...
    /** @return \Illuminate\Contracts\Pagination\LengthAwarePaginator<int, Material> newest first */
    #[Computed]
    ...
    // Queue the extraction for every adopted document without a material.
